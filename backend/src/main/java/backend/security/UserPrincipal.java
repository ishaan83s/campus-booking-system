...
public final class UserPrincipal implements UserDetails {
    private final Long id; private final String email; private final String password; private final Role role; private final boolean active;
    private UserPrincipal(User user) { id = user.getId(); email = user.getEmail(); password = user.getPassword(); role = user.getRole(); active = user.isActive(); }
